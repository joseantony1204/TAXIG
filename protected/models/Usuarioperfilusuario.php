...
class Usuarioperfilusuario extends CActiveRecord
{
	...
	public function search()
	{
		...
		$criteria->select='t.*, u.*';
		$criteria->join ='
		INNER JOIN TBL_USUARIOS  u ON u.USUA_ID = t.USUA_ID AND u.USUA_ID = '.Yii::app()->user->id;
	...
	public function getUsuariosPerfiles()
	{
	 ...
	 $criteria->join = '
	 INNER JOIN TBL_USUARIOSPERFILESUSUARIOS upu ON upu.USPE_ID = t.USPE_ID AND upu.USUA_ID = '.Yii::app()->user->id;	
