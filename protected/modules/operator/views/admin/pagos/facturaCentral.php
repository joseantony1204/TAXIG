<?php
 ...
 // Información referente al PDF
  ...
  $pdf->AddPage();
  ///***** CREANDO ARCHIVO *****///
 $facturas = $Pagos->facturaGeneral(1);
 ...
 $html .='
	   ...
	   <tr>
		...
		<td align="center" width="50%"><img src="/TAXIG/images/logo2.png" />
		 <font><br>NIT: 900.381.888 – 1<br>TEL: 728 3000 - 3002601151<br>
		 <strong>Carrera 15 No 20 - 31, Riohacha, La Guajira</strong>
		 <br><strong>Email taxiguajirasatelital@gmail.com</strong></font>
		</td>
		<td align="center" width="30%">
		  <table width="100%" border="1" align="left">
		   <tr>
            <td align="center"><br><strong><font size="9">RECIBO DE CAJA</font><br>
			<font color="red">'.$Pagos->PAGO_ID.'</font></strong></td>
           </tr>
		  </table>
		 </td>
       </tr>
	   <tr>
		...
		<table width="100%" border="1" align="left">
		  ...
		  $html .='
		   ...
		   <tr>
            <td colspan="3" align="left">OBSERVACIONES:<br><br><br></td>
