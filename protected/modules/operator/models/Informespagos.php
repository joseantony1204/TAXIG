 ...
 */
class Informespagos extends CFormModel
{
	public $CONT_FECHAINICIO;
	public $CONT_FECHAFINAL;	
	public $ESDS_ID, $VEHI_NUMEROMOVIL, $CONC_ID;
	...
	public function rules()
	{
		return array(
			...
			array('CONC_ID, CONT_FECHAINICIO, CONT_FECHAFINAL', 'required'),
		);
	}
