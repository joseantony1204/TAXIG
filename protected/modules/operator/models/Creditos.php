...
class Creditos extends CActiveRecord
{
   ...
   public function valorPagado($id)
	...
	public function searchCredito($id,$valor)
	{ 
	 ...
	 $this->agregarCuotas($Personas,$valor);    
	}
	
	private function agregarCuotas($Personas,$valor){
	...
	public	function reporteCreditos($Inf){
	 ...
	 $sql = "
	       SELECT  t.*, p.PERS_IDENTIFICACION, p.PERS_NOMBRES, p.PERS_APELLIDOS,
