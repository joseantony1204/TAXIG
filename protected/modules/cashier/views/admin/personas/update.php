...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('admin/personas/update','id'=>$Personas->PERS_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
  ...
  <tr>
    <td><p><?php echo $this->renderPartial('_form', array('Personas'=>$Personas)); ?></p></td>
  </tr>
</table>
