...
$this->breadcrumbs=array(
	'Documentosvehiculos'=>array('index'),
	'Crear',
);
?>
  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
		...
		DOCUMENTOSVEHICULOS  : Editar ] </strong></td>
        <td width="80" align="center">
         ...
         echo CHtml::link($image, array('documentosvehiculos/admin',),$htmlOptions ); 
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('documentosvehiculos/update','id'=>$model->DOHI_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
