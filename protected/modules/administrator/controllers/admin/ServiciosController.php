...
class ServiciosController extends Controller
{
	...
	$criteria->select = "p.PERS_NOMBRES, p.PERS_APELLIDOS, t.COAU_ID, v.VEHI_NUMEROMOVIL, v.VEHI_PLACA";		
	$criteria->join ='
		INNER JOIN TBL_VEHICULOS v ON v.VEHI_ID = t.VEHI_ID
		INNER JOIN TBL_CONDUCTORES c ON c.COND_ID = t.COND_ID
        INNER JOIN TBL_PERSONAS p ON p.PERS_ID = c.PERS_ID		/*AND t.ESCA_ID = 1*/';	
	$criteria->condition = "
	...
	'label' =>"[".$item->VEHI_NUMEROMOVIL." ".$item->VEHI_PLACA."] [".$item->PERS_NOMBRES." ".$item->PERS_APELLIDOS."]",
	);
	}
