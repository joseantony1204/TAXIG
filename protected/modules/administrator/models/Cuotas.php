...
class Cuotas extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('CRED_ID, PAGO_ID, CONC_ID', 'numerical', 'integerOnly'=>true),
			array('CUOT_VALOR', 'length', 'max'=>20),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('CUOT_ID, CUOT_VALOR, CUOT_FECHAPAGO, CRED_ID, PAGO_ID, CONC_ID', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'cONC' => array(self::BELONGS_TO, 'Conceptos', 'CONC_ID'),
		);
	}
