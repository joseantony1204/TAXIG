	      ...
	      <tr>
            ...
            <table width="100%" border="0">
	          <tr>
	            ...
	            <td>&nbsp;</td>
	            <td><?php echo $form->textFieldRow($Personas,'PERS_IDENTIFICACION',array('class'=>'span3')); ?></td>
	            </tr>
	          <tr>
	            <td>&nbsp;</td>
	            <td>&nbsp;</td>
	          ...
	          <tr>
	            <td width="33%"><?php echo $form->textFieldRow($Personas,'PERS_LUGAREXPIDENTIDAD',array('class'=>'span3')); ?></td>
	            <td width="35%">&nbsp;</td>
	            <td width="32%">
				<?php echo $form->labelEx($Personas,'SEXO_ID'); ?>
                <?php $data = CHtml::listData(Sexos::model()->findAll(),'SEXO_ID','SEXO_NOMBRE') ?>
                <?php echo $form->dropDownList($Personas,'SEXO_ID',$data, array('class'=>'span3','prompt'=>'Elige...')); ?> 
              ...
              <tr>
                <td><?php echo $form->textFieldRow($Personas,'PERS_NOMBRES',array('class'=>'span3')); ?></td>
                <td>&nbsp;</td>
                <td><?php echo $form->textFieldRow($Personas,'PERS_APELLIDOS',array('class'=>'span3')); ?></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
