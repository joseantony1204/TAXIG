...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('admin/creditos/update','id'=>$model->CRED_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
  ...
  <tr>
    <td><p><?php echo $this->renderPartial('_form2', array('model'=>$model)); ?></p></td>
  </tr>
</table>
