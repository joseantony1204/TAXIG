<?php
 ...
 // Información referente al PDF
  ...
  $html .='
       <tr>
        <td colspan="10" align="center"><strong>REPORTE DE VENTAS DE PRODUCTOS</strong></td>
       </tr>
       <tr>
        <td colspan="10" align="left">
		<strong>PERIODO DE VENTA : DESDE '.$Informes->CONT_FECHAINICIO.' HASTA '.$Informes->CONT_FECHAFINAL.'</strong></td>
       </tr>
	   <tr>
	   ...
	   <tr bgcolor="#E4E4E4">
		...
		<td align="center" width="15%"><strong>VALOR UNITARIO</strong></td>
		<td align="center" width="15%"><strong>VALOR TOTAL</strong></td>
	   </tr>			
	   '; 
  $pdf->SetFont('times', 'k', '9', true);
  $i=1;	$granTotal = 0;   	   
  foreach($registros as $rows){  
     $granTotal = $granTotal + $rows["VT"];
	 $html .='
	   <tr>
		<td align="center">'.$i.'</td>
		<td align="left">'.$rows["PROD_NOMBRE"].'</td>
		<td align="center">'.$rows["FAPR_CANTIDAD"].'</td>
		<td align="right">'.number_format($rows["PROD_VALORUNITARIO"]).'</td>
		<td align="right">'.number_format($rows["VT"]).'</td>
	   </tr>			
	   '; 
	$i++;     
  }
  $html .='
       <tr>
	    <td colspan="4" align="center" width="85%"><strong>TOTAL</strong></td>
        <td align="right" width="15%"><strong>'.number_format($granTotal).'</strong></td>
       </tr>';
