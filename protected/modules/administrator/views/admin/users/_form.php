...
<?php echo $form->errorSummary($Users); ?></p>
<table border="0" width="100%">
     <tr>
      <td width="90%">         
    ...
    <table width="100%" border="0">
      ...
      <tr>
        ...
        <td><?php echo $form->labelEx($Usuarios,'USUA_FECHABAJA'); ?>
          <?php
             $Usuarios->USUA_FECHABAJA = "0000-00-00 00:00:00";
             $this->widget('zii.widgets.jui.CJuiDatePicker', array(
             'model'=>$Usuarios,
      ...
      <tr>
        <td><?php if(($Usuarios->USUA_ULTIMOACCESO)==''){
			   $Usuarios->USUA_ULTIMOACCESO ="0000-00-00 00:00:00";
			  } 
	    ?>
          <?php echo $form->textFieldRow($Usuarios,'USUA_ULTIMOACCESO',array('class'=>'span2', 'readonly'=>'readonly')); ?></td>
        <td><?php echo $form->hiddenField($Users,'USPU_FECHAINGRESO',array('value'=>date("Y-m-d").' '.date("h:i:s"))); ?></td>
        <td><?php echo $form->labelEx($Users,'USPE_ID'); ?>
          <?php $data = CHtml::listData(Usuariosperfiles::model()->findAll(),'USPE_ID','USPE_NOMBRE') ?>
          <?php echo $form->dropDownList($Users,'USPE_ID',$data, array('class'=>'span3','prompt'=>'Elige...')); ?> <?php echo $form->error($Users,'USPE_ID'); ?></td>
      </tr>
    </table>
    </fieldset>
       </td>
...
<div class="form-actions">
		<?php $this->widget('bootstrap.widgets.TbButton', array(
			...
			'type'=>'success',
			'size'=>'small',
			'label'=>$Users->isNewRecord ? 'Crear' : 'Actualizar',
		)); ?>
	</div>
