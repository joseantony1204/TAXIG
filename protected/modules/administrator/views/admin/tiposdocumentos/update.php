...
$this->breadcrumbs=array(
	...
	'Tipos de Documentos'=>array('admin/tiposdocumentos/admin'),
	'Actualizar',
);
?>
  ...
  <tr>
    <td><table width="820" border="0" align="center">
      <tr>
		...
		TIPOS DE DOCUMENTOS  : Editar ] </strong></td>
...
?>         
        ...
        <?php
         ...
         $image = CHtml::image($imageUrl);
         echo CHtml::link($image, array('admin/tiposdocumentos/update','id'=>$model->TIDO_ID),$htmlOptions ); 
?>         
		          </td>
      </tr>
    </table></td>
